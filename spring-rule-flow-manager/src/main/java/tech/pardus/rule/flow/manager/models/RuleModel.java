...
public class RuleModel implements Serializable {
	...
	private void processDispatcher(Node<RulePart> currentNode, Map<String, ?> bindings) throws Exception {
		...
		managerBean.runDispatcher(actionModel.getDispatcherName(), args.toArray(new String[args.size()]));
	}
