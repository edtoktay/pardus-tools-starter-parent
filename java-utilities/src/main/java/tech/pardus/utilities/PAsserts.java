...
public class PAsserts {
  ...
  private static RuntimeException throwException(
      Supplier<String> message, Supplier<Class<? extends RuntimeException>> exceptionSuplier) {
    var msg = "Assert Exception Thrower";
    try {
      return nullSafeGetException(exceptionSuplier)
